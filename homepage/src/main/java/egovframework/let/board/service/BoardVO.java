...
//최종수정시점
	private java.util.Date lastUptPnttm;
//최종수정자ID
...
//관리자 여부
	...
	public java.util.Date getLastUptPnttm() {
		return lastUptPnttm;
	}
	public void setLastUptPnttm(java.util.Date lastUptPnttm) {
		this.lastUptPnttm = lastUptPnttm;
	}
